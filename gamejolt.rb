...
module GameJolt
  ...
  GameId = "90592"
  PrivateKey = "0ee5437349085dc74179c7afe158a7c7"
end
...
module GameJolt
  ...
  def self.delete_trophy(trophy_id)
      CustomData.delete("trophies", trophy_id)
      do_request("trophies/remove-achieved/?" + get_userdata_string() + "&trophy_id=" + trophy_id)
  end
  
  class Scene_Map < Scene_Base
    alias :gamejoltstart :start
    def start
      gamejoltstart
      if CustomData.get("isTrophySynced") != true
        sync_trophies()
      end
    end
  end
